      ...
      <div className="w-full max-w-sm">
        <div className="card">
          <div className="flex flex-col items-center mb-8">
            <Image src="/logo.png" alt="HurryOps" width={56} height={56} className="mb-3 rounded-xl" />
            <h1 className="text-2xl font-bold text-gray-900">HurryOps</h1>
            <p className="text-sm text-gray-500 mt-1">Sistema de gestión de envíos</p>
          </div>
          ...
          <p className="text-center text-xs text-gray-400 mt-6">
            Solo usuarios autorizados por HurryOps
          </p>
        </div>
      </div>
    </div>
